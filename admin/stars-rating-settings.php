...
if (!class_exists('Stars_Rating_Settings')) :
    ...
    final class Stars_Rating_Settings
    {
        ...
        {
            echo '<p class="description">' . esc_html('Check the post types on which you want to enable stars rating feature.') . '</p>';
        }
        ...
        {
            $new_value = isset($_POST['enabled_post_types']) ? $_POST['enabled_post_types'] : [];
            return $new_value;
        }
    }
